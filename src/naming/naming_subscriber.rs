...
impl PartialEq for ListenerClusterType {
    fn eq(&self, o: &Self) -> bool {
        match &self {
            ListenerClusterType::All => match &o {
                ListenerClusterType::All => true,
                ListenerClusterType::One(_) => false,
            },
            ListenerClusterType::One(a) => match &o {
                ListenerClusterType::All => false,
                ListenerClusterType::One(b) => a == b,
            },
        }
    }
}
